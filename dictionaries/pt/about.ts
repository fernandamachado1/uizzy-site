export default {
    ...
    missionTitle: "Missão",
    missionDesc: "Solucionar problemas por meio de projetos desenvolvidos com precisão técnica, responsabilidade e boas práticas, unindo criatividade e inovação para entregar segurança, desempenho e impacto real aos nossos clientes.",
